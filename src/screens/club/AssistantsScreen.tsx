    ...
    <View style={styles.card}>
      <View style={styles.cardHeader}>
        <View style={styles.cardHeaderLeft}>
          ...
          <Text style={styles.cardArchetype}>{ARCHETYPE_LABELS[assistant.archetype]}</Text>
        </View>
      ...
      <View style={styles.cardStats}>
        ...
        <View style={styles.stat}>
          <Text style={styles.statLabel}>WAGE/MO</Text>
      ...
      {assistant.willRetireNextSeason && (
        <View style={styles.retireBadge}>
          <Text style={styles.retireBadgeText}>RETIRING NEXT SEASON</Text>
        </View>
      )}
...
function EmptySlot({ role, onHire }: { role: AssistantRole; onHire: () => void }) {
  return (
    <Pressable style={styles.emptySlot} onPress={onHire}>
      ...
      <Text style={styles.emptySlotText}>Hire {ROLE_LABELS[role]}</Text>
    </Pressable>
  );
}
...
export function AssistantsScreen() {
  ...
  const handleDismiss = (assistant: AssistantWithQuality) => {
    Alert.alert(
      'Dismiss Assistant',
      `Are you sure you want to dismiss ${assistant.name}?`,
      [
  ...
  return (
    <ScrollView style={commonStyles.screen} contentContainerStyle={styles.container}>
      {roles.map((role) => {
        ...
        return (
          <View key={role}>
            <Text style={styles.sectionTitle}>{ROLE_LABELS[role].toUpperCase()}</Text>
            {assistant ? (
